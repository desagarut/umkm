    ...
    <section class="hero-area">
      ...
      <div class="col-lg-8 col-12 custom-padding-right">
            ...
            <div class="single-slider"
               ...
               <div class="content">
               <h4 style="color:#FFF; text-shadow: 4px 4px 4px #081828; -webkit-text-stroke: 0.25px #081828;"><?= $data['kategori_toko'] ?></h4>
                <h2 style="color:#FFF; text-shadow: 5px 5px 5px #081828; -webkit-text-stroke: 0.25px #081828;">UMKM : <?= $data['nama'] ?></h2>
