      ...
      <div class="col-lg-3 col-md-6 col-12"> 
        ...
        <div class="single-product">
          <div class="product-image"> <img src="<?= AmbilGaleri($data['gambar'],'kecil') ?>" alt="#">
            <div class="button"> <a href="<?= site_url('first/produk_show/'.$data['id']) ?>" class="btn"><i class="lni lni-cart"></i> Lihat Produk</a> </div>
          </div>
          <div class="product-info"> <span class="category">Watches</span>
